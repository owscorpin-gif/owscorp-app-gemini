        ...
        <div className="p-6 flex flex-col flex-grow">
            ...
            {onOpenModal && (
                <button
                    ...
                    className="w-full mt-4 bg-primary text-white font-bold py-2 px-4 rounded-lg opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                    Quick View
                </button>
            )}
        </div>
